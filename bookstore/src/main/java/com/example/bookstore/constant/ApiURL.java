...
public class ApiURL {
    ...
    public static final String ADDRESS = Constant.API + Constant.ADMIN +  Constant.ADDRESS;
    public static final String BOOK_TAG = Constant.API + Constant.ADMIN +  Constant.BOOK_TAG;
    public static final String DISCOUNT = Constant.API + Constant.ADMIN +  Constant.DISCOUNT;
    public static final String DISCOUNT_OF_USER = Constant.API + Constant.ADMIN +  Constant.DISCOUNT_OF_USER;
    public static final String DISCOUNT_APPLY = Constant.API + Constant.ADMIN +  Constant.DISCOUNT_APPLY;
